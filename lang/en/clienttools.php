...
return [
    ...
    // Field labels carrying the reference's own capitalisation. The shared theme keys
    // read "First name" / "Postcode"; the reference reads "First Name" / "Zip Code", and
    // this screen is meant to match it word for word.
    ...
    'contact_country_none' => '—',
    'email_preferences' => 'Email Preferences',
    'email_pref_general' => 'General Emails - General Announcements & Password Reminders',
    'email_pref_invoice' => 'Invoice Emails - Invoices & Billing Reminders',
    'email_pref_support' => 'Support Emails - Receive a copy of all support ticket communications created by the parent account holder',
    'email_pref_product' => 'Product Emails - Order Details, Welcome Emails, etc...',
    'email_pref_domain' => 'Domain Emails - Renewal Notices, Registration Confirmations, etc...',
];
