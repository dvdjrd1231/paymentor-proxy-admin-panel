...
/**
 * ITU E.164 country calling codes by ISO-3166 alpha-2, for the phone field's prefix.
 */
class DialCodes
{
    private const MAP = [
    ...
    /** "+1" for US, or null when the code is unknown. */
    public static function for(?string $iso2): ?string
    {
        $code = self::MAP[strtoupper(trim((string) $iso2))] ?? null;
